...
num_users_poisson = 5;
num_users_periodic = 5;
num_users = num_users_periodic + num_users_poisson;

%     lambda_users = (0.4-0.1).*rand(10, num_users) + 0.1;
lambda_periodic_users = ones(10, num_users_periodic);
offset_users = (0.5 - 0).*rand(10, num_users_periodic) + 0;
lambda_poisson_users = ones(10, num_users_poisson);
higher = 2;
...
[ground_indices, final_arrival_times, departure_timestamps, waiting_times, buffer_lengths, largest_time] = first_node(num_users_periodic, num_users_poisson, lambda_periodic_users(1, :), offset_users(1, :), lambda_poisson_users(1, :), mu_node, epsilon_node(1), num_events, num_events_considered);
