...
[ground_indices, final_arrival_times, departure_timestamps, waiting_times, buffer_lengths, largest_time] = first_node_retr(num_users, lambda_users(1, :), offset_users(1, :), mu_node, epsilon_node(1), num_events, num_events_considered, max_retransmissions);
